...
// Problem 1
//event director wants emails and last names of each person to send them a thank you letter
let info = [runner.forEach(function(email, last_name){
})];
console.log(info);

// Problem 2
//there are a lot of people with the same names running so he now wants the last names to be all caps to match.
...
// Problem 3
//director needs a list of everyone with the first name of hank because there is a hank running that is wanted
let hankHunt = [runners.filter(function(first_name) {
    return first-name === "Hank";
})];
